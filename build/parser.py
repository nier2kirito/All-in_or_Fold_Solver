...
def aggregate_hand_data_from_files(updated = False):
    if updated : 
        file_paths =glob.glob('infosets_updated_2_blidns_0_4_1*.txt')
    else:
...
#     for (decisions, hand), (fold_prob, all_in_prob) in hand_data_final.items():
#         if decisions == 'P0:[P1:P][P2:F][P3:F]':
#             print(fold_prob, all_in_prob)
